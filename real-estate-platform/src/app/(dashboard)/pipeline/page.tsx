    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-screen-2xl mx-auto px-4 py-8">
        ...
        {!isLoading && !error && data && data.total === 0 && (
          <div className="mb-6 rounded-xl border-2 border-dashed border-blue-200 bg-blue-50/50 p-8 text-center">
            <svg className="mx-auto h-10 w-10 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m3.75 9v6m3-3H9m1.5-12H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
            </svg>
            <h3 className="mt-3 text-lg font-semibold text-gray-900">No deals yet</h3>
            <p className="mt-1 text-sm text-gray-500">Import properties and create deals to start building your pipeline.</p>
            <div className="mt-4 flex justify-center gap-3">
              <Link href="/import" className="rounded-lg bg-blue-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-700 transition-colors">
                Import Properties
              </Link>
              <Link href="/properties" className="rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 transition-colors">
                Browse Properties
              </Link>
            </div>
          </div>
